...
toolName="echo"
toolPath="/u/home/k/keithgmi/tools/ec/echo/echo_v1_12"
...
python /u/home/k/keithgmi/tools/ec/echo/echo_v1_12/ErrorCorrection.py -k $kmer -o $outdir/one_output_file.fastq $outdir/merged_input_file.fastq >> $logfile 2>&1
